...
export default function Decodificador({value}) {
    return (
        <div className="p-4 bg-yellow-200/40 border-2 border-yellow-300 rounded-md">
            <div className="flex items-center border-2 border-yellow-300 font-bold p-2 mb-2">
                <div className="flex justify-center items-center border-2 border-black w-7 h-7 absolute right-1/4 text-xl">{value}</div>
